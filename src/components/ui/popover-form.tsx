  ...
  return (
    ...
    >
      <motion.button
        ...
        className="flex h-7 items-center border border-border bg-card px-2.5 text-[11px] font-medium text-current outline-none"
      >
            ...
            <AnimatePresence mode="popLayout">
              {showSuccess ? (
                ...
                <motion.div
                  ...
                  className="h-full border border-border bg-card z-20"
                >
                  {openChild}
                </motion.div>
              )}
